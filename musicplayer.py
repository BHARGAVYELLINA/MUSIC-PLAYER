...
class PlaylistGUI:
    def __init__(self):
        ...
        self.play_first_button = ttk.Button(self.frame2, text="Play first", command=self.play_first, style="Custom.TButton")
        self.play_first_button.pack()

        self.play_last_button = ttk.Button(self.frame2, text="Play Last", command=self.play_last, style="Custom.TButton")
        self.play_last_button.pack()

        self.remove_all_button = ttk.Button(self.frame2, text="Remove All Songs", command=self.remove_all_songs, style="Custom.TButton")
        self.remove_all_button.pack()

        self.add_button = ttk.Button(self.frame2, text="Add Music", command=self.add_music, style="Custom.TButton")
        self.add_button.pack()

        self.display_total_playlist_time_button = ttk.Button(self.frame2, text="Total Playlist Time", command=self.display_total_playlist_time, style="Custom.TButton")
        self.display_total_playlist_time_button.pack()

        self.load_button = ttk.Button(self.frame2, text="Load Playlist", command=self.load_playlist, style="Custom.TButton")
        self.load_button.pack(pady=5)
        self.load_entry = tk.Entry(self.frame2, font=("Arial", 12))
        self.load_entry.pack(pady=5)

        self.select_song_button = ttk.Button(self.frame2, text="Select Song", command=self.select_song, style="Custom.TButton")
        self.select_song_button.pack(pady=5)
        self.select_entry = tk.Entry(self.frame2, font=("Arial", 12))
        self.select_entry.pack(pady=5)

        self.save_button = ttk.Button(self.frame2, text="Save Playlist", command=self.save_playlist, style="Custom.TButton")
        self.save_button.pack(pady=5)
        self.save_entry = tk.Entry(self.frame2, font=("Arial", 12))
        self.save_entry.pack(pady=5)

        self.remove_button = ttk.Button(self.frame2, text="Remove Music", command=self.remove_music, style="Custom.TButton")
        self.remove_button.pack(pady=5)
        self.remove_entry = tk.Entry(self.frame2, font=("Arial", 12))
        self.remove_entry.pack(pady=5)

        self.set_volume_button = ttk.Button(self.frame2, text="Set Volume", command=self.set_volume, style="Custom.TButton")
        self.set_volume_button.pack(pady=5)
        self.volume_entry = tk.Entry(self.frame2, font=("Arial", 12))
        self.volume_entry.pack(pady=5)

        self.skip_duration_button = ttk.Button(self.frame2, text="Skip Duration", command=self.skip_duration, style="Custom.TButton")
        self.skip_duration_button.pack(pady=5)
        self.duration_entry = tk.Entry(self.frame2, font=("Arial", 12))
        self.duration_entry.pack(pady=5)

        self.show_button = ttk.Button(self.frame2, text="Show Playlist", command=self.show_playlist, style="Custom.TButton")
        self.show_button.pack()

        self.sort_playlist_button = ttk.Button(self.frame2, text="Sort Playlist", command=self.sort_playlist, style="Custom.TButton")
        self.sort_playlist_button.pack()

        self.shuffle_playlist_button = ttk.Button(self.frame2, text="Shuffle Playlist", command=self.shuffle_playlist, style="Custom.TButton")
        self.shuffle_playlist_button.pack()

        self.loop_playlist_button = ttk.Button(self.frame2, text="Loop Playlist", command=self.loop_playlist, style="Custom.TButton")
        self.loop_playlist_button.pack()

        self.most_played_button = ttk.Button(self.frame1, text="Most Played", command=self.most_played, style="Custom.TButton")
        self.most_played_button.pack()

        self.image = Image.open(r"IMAGES/Home.jpg")
        self.image = self.image.resize((500, 600))
        self.photo = ImageTk.PhotoImage(self.image)
        self.image_label = tk.Label(self.frame, image=self.photo)
        self.image_label.pack()

        self.song_details_label = tk.Label(self.frame1, text="", font=("Helvetica", 14), wraplength=300)
        self.song_details_label.pack()

        self.play_previous_button = ttk.Button(self.frame, text="|◁", command=self.play_previous, style="Custom1.TButton")
        self.play_previous_button.pack(side="left", fill=tk.BOTH, expand=True, padx=1)

        self.pause_resume_button = ttk.Button(self.frame, text="▶", command=self.pause_resume, style="Custom1.TButton")
        self.pause_resume_button.pack(side="left", fill=tk.BOTH, expand=True, padx=1)

        self.play_next_button = ttk.Button(self.frame, text="▷|", command=self.play_next, style="Custom1.TButton")
        self.play_next_button.pack(side="left", fill=tk.BOTH, expand=True, padx=1)

        self.repeat_current_song_button = ttk.Button(self.frame, text="🔁", command=self.repeat_current_song, style="Custom1.TButton")
    ...
    def most_played_song_details(self):
        ...
        if self.playlist.current_song:
            ...
            self.most_played_song_label = tk.Label(
                self.frame1, text=details_text, font=("Comic Sans MS", 14, "bold"), fg="white", bg="black")
            self.most_played_song_label.pack()
    ...
    def save_playlist(self):
        ...
        self.playlist.save_playlist("playlist.txt")

    def load_playlist(self):
        filename = self.load_entry.get()
        show = self.playlist.load_playlist("playlist.txt")
        if show:
            self.display(show)
            self.update_song_details_label()
            self.playlist.pause()
